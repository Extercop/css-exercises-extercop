...
### Self Check
- Does each element have a unique class name? yy
- Did you use the grouping selector for styles that both elements share? yy
- Did you make separate rules for the styles unique to each element? yy
